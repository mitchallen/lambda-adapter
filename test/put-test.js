            ...
            it('should echo back post body values', done => {
                ...
                request(testHost)
                    ...
                    .end(function (err, res) {
                        ...
                        res.body.body.alpha.should.eql(putObject.alpha);
                        res.body.body.beta.should.eql(putObject.beta);
                        res.body.body.email.should.eql(putObject.email);
                        res.body.body.boolTest.should.eql(putObject.boolTest);
                        done();
                    });
            });
