module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            dist: {
                options: {
                    browserifyOptions: {
                        ...
                        standalone: 'MitchAllen.-lambda-adapter'
                        // standalone: 'mitchallen.-lambda-adapter'
                    },
                ...
                files: {
                   ...
                   "./dist/lambda-adapter.js": ["./modules/index.js"]
                   // For non-standalone, use ./browser.js instead.
                   // "./dist/lambda-adapter.js": ["./browser.js"]
                }
            }
        },
        ...
        uglify: {
            my_target: {
                files: {
                    './dist/lambda-adapter.min.js': ['./dist/lambda-adapter.js']
                }
            }
        },
